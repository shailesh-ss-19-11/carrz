...
export default function EngineRestorationPage() {
    return (
        <div className="bg-background min-h-screen relative overflow-hidden">
            {/* Hero Section */}
            <div className="pt-10 pb-10 md:pt-16 md:pb-16 border-b border-surface-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-8 md:mb-10 tracking-tight text-center">Engine Restoration</h1>
                    <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden border-2 border-surface-border shadow-2xl">
                        <img
                            src="/car-detailing-icons/engine-cleaning.jpg"
                            alt="Engine Restoration"
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 md:mt-8">
                        ...
                        <a
                            href="https://wa.me/917709959881?text=Hi%2C%20I%27m%20interested%20in%20Engine%20Restoration.%20Please%20share%20more%20details."
                            target="_blank"
                ...
                <div className="md:bg-surface/50 md:backdrop-blur-md md:rounded-[2.5rem] md:p-14 md:border md:border-surface-border md:shadow-xl space-y-10 md:space-y-16">
                    ...
                    <div>
                        ...
                        <p className="text-muted text-lg leading-relaxed font-light">
                            Engine restoration is a comprehensive cleaning and detailing service for your vehicle's engine bay. Over time, dust, grease, oil leaks, and grime accumulate under the hood, reducing cooling efficiency and making it harder to spot potential issues. Our expert process safely degreases and restores the engine bay to a near-factory clean condition.
                        </p>
                    </div>
                    ...
                    <div>
                        <h2 className="text-3xl font-extrabold text-foreground mb-6 tracking-tight flex items-center gap-3">
                            ...
                            Why choose Engine Restoration?
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                { title: 'Improved Performance', desc: 'A clean engine runs cooler and more efficiently. Removing grime helps with better heat dissipation and overall performance.' },
                                { title: 'Early Leak Detection', desc: 'A clean engine bay makes it easy to spot oil leaks, coolant drips, and worn hoses before they become costly problems.' }
                            ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 pt-8 border-t border-surface-border">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                {[
                                    { step: 1, title: 'Protective Covering', desc: 'Cover sensitive electrical components, sensors, and the air intake.' },
                                    { step: 2, title: 'Degreasing', desc: 'Apply a professional-grade degreaser to break down oil and grime.' },
                                    { step: 3, title: 'Agitation & Rinse', desc: 'Carefully scrub with detailing brushes and rinse with controlled low-pressure water.' },
                                    { step: 4, title: 'Dressing & Protection', desc: 'Apply engine bay dressing for a clean, matte-finish look and UV protection.' },
                                ].map((item) => (
