...
export default function ExteriorPolishingPage() {
    return (
        <div className="bg-background min-h-screen relative overflow-hidden">
            {/* Hero Section */}
            <div className="pt-10 pb-10 md:pt-16 md:pb-16 border-b border-surface-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-8 md:mb-10 tracking-tight text-center">Exterior Polishing</h1>
                    <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden border-2 border-surface-border shadow-2xl">
                        <img
                            src="/car-detailing-icons/exterior-polishing.jpeg"
                ...
                <div className="md:bg-surface/50 md:backdrop-blur-md md:rounded-[2.5rem] md:p-14 md:border md:border-surface-border md:shadow-xl space-y-10 md:space-y-16">
                    ...
                    <div>
                        ...
                        <p className="text-muted text-lg leading-relaxed font-light">
                            Exterior polishing is a multi-stage machine compounding and buffing procedure that surgically removes a microscopic layer of clear coat. This process removes scratches, haze, and oxidation, restoring the factory shine.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                { title: 'Makes Car Look New', desc: 'Revives faded paint and drastically improves gloss clarity.' }
                            ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 pt-8 border-t border-surface-border">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    'Restores absolute gloss finish',
                                    'Significantly better overall look'
                                ].map((benefit, idx) => (
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                {[
                                    { step: 1, title: 'Wash', desc: 'Exterior wash to remove heavy grit and dirt.' },
                                    { step: 2, title: 'Inspect', desc: 'Paint thickness and defect evaluation.' },
                                    { step: 3, title: 'Polish', desc: 'Machine compounding to remove imperfections.' },
                                    { step: 4, title: 'Finish', desc: 'Final jeweling polish and sealant application.' },
                                ].map((item) => (
                    ...
                    <div className="pt-8 text-center">
                        ...
                        >
                            ...
                            Book Exterior Polishing
                        </a>
                        <p className="text-muted mt-4 text-sm font-light">Call our detailing experts to restore your car's gloss.</p>
                    </div>
