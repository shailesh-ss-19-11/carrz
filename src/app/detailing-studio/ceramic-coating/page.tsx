        ...
        <div className="bg-background min-h-screen relative overflow-hidden">
            ...
            <div className="pt-10 pb-10 md:pt-16 md:pb-16 border-b border-surface-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-8 md:mb-10 tracking-tight text-center">Ceramic Coating</h1>
                    <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden border-2 border-surface-border shadow-2xl">
                        <img
                            src="/car-detailing-icons/ceramic-coating.jpeg"
                            alt="Ceramic Coating"
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 md:mt-8">
                        <div className="bg-primary/10 border border-primary/30 rounded-full px-6 py-3">
                            <span className="text-primary font-extrabold text-lg md:text-xl">Starting from ₹12,999</span>
                        </div>
                        <a
                            href="https://wa.me/917709959881?text=Hi%2C%20I%27m%20interested%20in%20Ceramic%20Coating.%20Please%20share%20more%20details."
                            target="_blank"
