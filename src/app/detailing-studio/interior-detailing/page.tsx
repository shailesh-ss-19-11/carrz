        ...
        <div className="bg-background min-h-screen relative overflow-hidden">
            ...
            <div className="pt-10 pb-10 md:pt-16 md:pb-16 border-b border-surface-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-8 md:mb-10 tracking-tight text-center">Interior Detailing</h1>
                    <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden border-2 border-surface-border shadow-2xl">
                        <img
                            src="/car-detailing-icons/interior-cleaning.jpeg"
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 md:mt-8">
                        ...
                        <a
                            href="https://wa.me/917709959881?text=Hi%2C%20I%27m%20interested%20in%20Interior%20Detailing.%20Please%20share%20more%20details."
                            target="_blank"
                ...
                <div className="md:bg-surface/50 md:backdrop-blur-md md:rounded-[2.5rem] md:p-14 md:border md:border-surface-border md:shadow-xl space-y-10 md:space-y-16">
                    ...
                    <div>
                        ...
                        <p className="text-muted text-lg leading-relaxed font-light">
                            Interior detailing is a comprehensive deep cleaning of your vehicle's inner cabin. We target the dashboard, seating (leather and fabric), carpets, and roof lining to extract dirt and eliminate stubborn stains.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                { title: 'Hygiene', desc: 'Sanitizes high-touch areas from harmful bacteria and germs.' },
                                { title: 'Removes Odor', desc: 'Eliminates lingering smells from smoke, pets, or food spills.' }
                            ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 pt-8 border-t border-surface-border">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    'Interior plastic & leather protection'
                                ].map((benefit, idx) => (
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                {[
                                    { step: 1, title: 'Vacuum', desc: 'Intensive dirt extraction from all crevices.' },
                                    { step: 2, title: 'Shampoo', desc: 'Wet-vac and steam cleaning of fabric materials.' },
                                    { step: 3, title: 'Polish', desc: 'Dashboard and plastic panel restoration.' },
                                    { step: 4, title: 'Sanitization', desc: 'AC vents cleaning and overall deodorizing.' },
                                ].map((item) => (
                    ...
                    <div className="pt-8 text-center">
                        ...
                        >
                            ...
                            Call to Book Interior Detail
                        </a>
                        <p className="text-muted mt-4 text-sm font-light">Contact us to schedule your deep cleaning service.</p>
                    </div>
