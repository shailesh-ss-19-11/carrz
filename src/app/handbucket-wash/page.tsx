...
import { Check, Info, Droplets, Sparkles } from 'lucide-react';
...
export default function HandBucketWashPage() {
    const [selectedPackage, setSelectedPackage] = useState(washPackages[1]); // Default to Premium
                                    ...
                                    <div className="flex flex-col items-center justify-between h-full z-10 w-full relative">
                                        ...
                                        <div className="w-full flex flex-col items-center mt-2">
                                            ...
                                            <div className="flex flex-col items-center mt-auto">
                                                ...
                                                {pkg.name.includes('Monthly') && <span className="text-muted font-medium text-sm mt-1">/mo</span>}
                                            </div>
                                        </div>
                                    </div>
                                </button>
                ...
                <div className="mt-24 border border-surface-border bg-gradient-to-r from-surface to-background rounded-[2rem] p-8 md:p-10 flex flex-col sm:flex-row gap-6 items-start md:items-center max-w-4xl mx-auto shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-muted text-sm md:text-base font-light leading-relaxed">
                            Prices are applicable for hatchback and compact sedan cars. SUVs, MUVs, and luxury vehicles might incur a small extra charge due to the increased surface area. We require access to a water connection and minimum clearance around the vehicle to perform the two-bucket wash properly.
                        </p>
                    </div>
                </div>
            </div>
