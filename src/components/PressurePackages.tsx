...
import { CheckCircle2, Droplets, Sparkles, ChevronDown, X } from "lucide-react";
...
export default function PressurePackages() {
        ...
        <div className="w-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl perspective-1000">
                {packages.map((pkg, index) => (
                    <div key={pkg.id} className="w-full block">
                        <div
                        ...
                        >
                            <div className="bg-surface/90 backdrop-blur-xl border border-primary/30 rounded-3xl p-6 relative shadow-2xl flex flex-col gap-8">
                                ...
                                <div className="flex flex-col items-center text-center pt-8">
                                    ...
                                    <p className="text-xs text-muted mt-4">Note: Prices may vary depending on vehicle type (Hatchback / Sedan / SUV).</p>
                                </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
                            ...
                            <div className="w-full md:w-1/3 flex flex-col items-center text-center">
                                ...
                                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary mb-4">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wider">Pressure Care</span>
                                </div>
